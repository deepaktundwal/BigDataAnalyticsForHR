...
namespace Server.Source.LinkedIn
{
    public class OAuthLinkedIn : oAuthBase
    {
        ...
        private string _consumerKey = "6bpbbe18d3g5";
        private string _consumerSecret = "AXk3MwOFObDkBPMd";
        private string _token = "dd82d23a-5631-458c-9de3-ec8cfe5a8476";
        private string _tokenSecret = "ed0457b8-b2f4-49ae-9cb6-037545284ee9";
        ...
        public OAuthLinkedIn(Source.LinkedIn.OAuthTokens oAuthTokens)
        {
            this.ConsumerKey = oAuthTokens.ConsumerKey;
            this.ConsumerSecret = oAuthTokens.ConsumerSecret;
            this.Token = oAuthTokens.AccessToken;
            this.TokenSecret = oAuthTokens.AccessTokenSecret;
        }
        /// <summary>
        ...
        public string WebResponseGet(HttpWebRequest webRequest)
        {
            ...
            try
            {
                byte[] arrresponseData = ReadStream(webRequest.GetResponse().GetResponseStream());
                responseData = Encoding.UTF8.GetString(arrresponseData, 0, arrresponseData.Length);
